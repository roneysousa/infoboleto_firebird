object frmCadTitulos: TfrmCadTitulos
  Left = 184
  Top = 118
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object lblValorDespesaCobranca: TLabel
        Left = 447
        Top = 346
        Width = 115
        Height = 13
        Alignment = taRightJustify
        Anchors = [akTop, akRight]
        Caption = 'Valor despesa cobran'#231'a'
      end
      ...
      object Panel1: TPanel
        ...
        object BtPesquisar: TBitBtn
          ...
          Glyph.Data = {
            36050000424D3605000000000000360400002800000010000000100000000100
            08000000000000010000230B0000230B00000001000000000000000000004000
            ...
            
            FFFFFFFFFFFFFFFFFFFF92FFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
        end
      ...
      object cmbCedente: TDBLookupComboBox
        Left = 18
        Top = 204
        Width = 400
        Height = 21
        DataField = 'REC_NMCEDENTE'
        DataSource = dsReceber
        TabOrder = 2
      end
      object dbeDTDOCU: TDBDateEdit
        Left = 17
        Top = 242
        Width = 121
        Height = 21
        DataField = 'REC_DTDOCUMENTO'
        DataSource = dsReceber
        NumGlyphs = 2
        TabOrder = 3
        OnExit = dbeDTDOCUExit
      end
      ...
      object dbeNossoNumero: TDBEdit
        ...
        DataSource = dsReceber
        TabOrder = 5
        OnExit = dbeNossoNumeroExit
        OnKeyPress = dbeNossoNumeroKeyPress
      end
      object dbeVLDOCU: TDBEdit
        Left = 428
        Top = 204
        Width = 134
        Height = 21
        DataField = 'REC_VLDOCUMENTO'
        DataSource = dsReceber
        TabOrder = 7
      end
      object dbeVLDESC: TDBEdit
        ...
        Width = 134
        Height = 21
        DataField = 'REC_VLDESCONTO'
        DataSource = dsReceber
        TabOrder = 8
      end
      object dbeVLABAT: TDBEdit
        Left = 428
        Top = 283
        Width = 134
        Height = 21
        DataField = 'REC_VLABATIMENTO'
        DataSource = dsReceber
        TabOrder = 9
      end
      ...
      object dbeVLDESP: TDBEdit
        ...
        Width = 134
        Height = 21
        DataField = 'REC_VLDESPESACOBRANCA'
        DataSource = dsReceber
        TabOrder = 11
      end
      ...
      object GroupBox1: TGroupBox
        ...
        object dbeNMSACA: TDBEdit
          Left = 8
          Top = 34
          Width = 397
          Height = 21
          CharCase = ecUpperCase
          DataField = 'REC_NMSACADO'
          DataSource = dsReceber
          TabOrder = 0
        end
        object dbeCPFCNJP: TDBEdit
          Left = 411
          Top = 33
          Width = 121
          Height = 21
          DataField = 'REC_CPFCNPJ'
          DataSource = dsReceber
          TabOrder = 1
        end
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object Label10: TLabel
          ...
          Height = 13
          Caption = 'Mensagem:'
          FocusControl = mmoInstrucoes
        end
        object mmoInstrucoes: TDBMemo
          Left = 12
          Top = 21
          Width = 549
          Height = 78
          DataField = 'REC_OBSERVACAO2'
          DataSource = dsReceber
          ScrollBars = ssVertical
          TabOrder = 0
        end
      ...
      object Panel3: TPanel
        ...
        object grdConsultar: TDBGrid
          ...
          Align = alClient
          Ctl3D = False
          DataSource = dmBoleto.dsParcelas
        ...
        object Panel6: TPanel
          ...
          object dbeVLENTR: TDBEdit
            Left = 16
            Top = 20
            Width = 100
            Height = 21
            DataField = 'PAR_VLENTRADA'
            DataSource = dmBoleto.dsParcelas
            TabOrder = 0
          end
  ...
  object dsReceber: TDataSource
    AutoEdit = False
    DataSet = dmBoleto.cdsContasReceber
    Left = 336
    Top = 8
  end
  ...
  object datasetConsultar: TSQLDataSet
    CommandText = 
      'select REC_CREDITO, REC_NMSACADO, REC_DTDOCUMENTO, REC_DTVENCIME' +
      'NTO, REC_DTRECEBIMENTO from CONTASRECEBER'
    MaxBlobSize = -1
    Params = <>
  ...
  object cdsConsultar: TClientDataSet
    ...
    Left = 468
    Top = 10
    object cdsConsultarREC_CREDITO: TIntegerField
      FieldName = 'REC_CREDITO'
      Required = True
      DisplayFormat = '0000000000'
    end
    object cdsConsultarREC_NMSACADO: TStringField
      FieldName = 'REC_NMSACADO'
      Size = 50
    end
    object cdsConsultarREC_DTDOCUMENTO: TDateField
      FieldName = 'REC_DTDOCUMENTO'
    end
    object cdsConsultarREC_DTVENCIMENTO: TDateField
      FieldName = 'REC_DTVENCIMENTO'
    end
    object cdsConsultarREC_DTRECEBIMENTO: TDateField
