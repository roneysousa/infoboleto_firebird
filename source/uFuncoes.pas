...
StdCtrls, Mask,Db, DBTables,DBIProcs,TypInfo,WinProcs, ExtCtrls, uFrmPrincBoleto,
ExtDlgs,Jpeg;
...
Procedure Limpar_Status;
begin
     frmPrincBoleto.StatusBar1.Panels[2].Text := ' ';
     frmPrincBoleto.StatusBar1.Panels[1].Text := '';
end;
